...
// see `ai-tests/user.rest.test.js for variations generated by Copilot and using supergent in a different way
...
test('Can post a new user - axios version', async () => {
  // more concise version using axios
  const postResponse = await axios.post(HOST + '/users', dummy);
  expect(postResponse.status).toBe(201);

  const getResponse = await axios.get(HOST + '/users');
